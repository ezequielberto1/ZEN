...
public class OrdenarLista { /*Conviene ordenar los vectores antes que las tables*/

	private int nivel;
	private JFrame frmOrdenarLista;
	private int o1, o2, o3, AD1, AD2, AD3;
	...
	private void initialize(Vector<String> items) {
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				o1 = cmbOrdenar1.getSelectedIndex();
				AD1 = cmbOrdenar1AD.getSelectedIndex();
				if (nivel >= 2) 
					if (o1 != o2) {
						o2 = cmbOrdenar2.getSelectedIndex();
						AD2 = cmbOrdenar2AD.getSelectedIndex();
						if (nivel == 3) {
							if (o1 != o3 && o2 != o3) 
								o3 = cmbOrdenar3.getSelectedIndex();
							AD3 = cmbOrdenar3AD.getSelectedIndex();
						} else 
							JOptionPane.showMessageDialog(null, "Hay columnas repetidas.");
					} else 
						JOptionPane.showMessageDialog(null, "Hay columnas repetidas.");
			}
		});
		...
		btnQuitarNivel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case 2: {
					cmbOrdenar2.setEnabled(false);
					cmbOrdenar2.setSelectedIndex(-1);
					cmbOrdenar2AD.setEnabled(false);
					cmbOrdenar2AD.setSelectedIndex(-1);
					btnQuitarNivel.setEnabled(false);
					nivel = 1;
					break;
				}
				case 3: {
					cmbOrdenar3.setEnabled(false);
					cmbOrdenar3.setSelectedIndex(-1);
					cmbOrdenar3AD.setEnabled(false);
					cmbOrdenar3AD.setSelectedIndex(-1);
